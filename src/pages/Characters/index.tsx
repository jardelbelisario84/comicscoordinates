    ...
    <HomeContainer>
      ...
      <HomeBanner>
        <HomeBannerContent>
          ...
          <BannerSubtitle>Envie seus quadrinhos favoritos para um endereço no mapa</BannerSubtitle>
        </HomeBannerContent>
      </HomeBanner>
            ...
            <ModalContent>
              ...
              <ModalBody>
                ...
                <li>
                  <h2>Publicados:</h2>
                  <span>
                    Data: {character?.dates?.[0]?.date && format(parseISO(character?.dates?.[0]?.date), "dd/MM/yyyy")}
                  </span>
                </li>
